...
namespace Uni_Form_Trans_Test_01
{
    public partial class Setting : Form
    {
        ...
        private void Setting_Load(object sender, EventArgs e)
        {
            ...
            trackBar1.Value = val;
            trackBar2.Value = Properties.Settings.Default.DELAY;
        ...
        private void trackBar2_Scroll(object sender, EventArgs e)
        {
            ...
            Properties.Settings.Default.WAIT_RUN = (int)(500 / scale);
            Properties.Settings.Default.WAIT_RESTCHANGE = (int)(2000 / scale);
            Properties.Settings.Default.DELAY = trackBar2.Value;
            Properties.Settings.Default.Save();
        }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (hWnd != null && !hWnd.Equals(IntPtr.Zero))
            {
                ...
                if (className.ToString().Contains("WMP"))
                {
                    dino.ChangeSetting("CUSTOM_TRANSPARENCY", 0.3f);
                    Console.WriteLine("YES");
                }
                else
                    dino.ChangeSetting("CUSTOM_TRANSPARENCY", 1.0f);
